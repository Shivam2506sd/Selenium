...
@Listeners(CommonUtils.ListenerImpementation.class);
public class Organization {
	
	
	
	CommonUtils.PropertyFileUtil putil = new CommonUtils.PropertyFileUtil();
	
	CommonUtils.WebDriverUtil wutil = new CommonUtils.WebDriverUtil();
	
	CommonUtils.ExcelUtil eutil = new CommonUtils.ExcelUtil();
	
	CommonUtils.javautil jutil = new CommonUtils.javautil();
